...
import com.bugtsa.casher.casherresourceserver.mainly.model.PaymentFullDto
...
class PaymentController {
    ...
    @GetMapping("$PAYMENT_NAME_METHOD/date&user")
    fun getPaymentsByUserDate(@RequestParam("userId") userId: Int,
                              @RequestParam("month") monthNumber: Int,
                              @RequestParam("year") yearNumber: Int
    ) = ResponseEntity(paymentService.getPaymentsByUserDate(userId, monthNumber, yearNumber), HttpStatus.OK)

    @GetMapping("$PAYMENT_NAME_METHOD/date&user/categorized")
    fun getPaymentsByUserDateOutputInfo(@RequestParam("userId") userId: Int,
                                        @RequestParam("month") monthNumber: Int,
                                        @RequestParam("year") yearNumber: Int,
                                        @RequestParam("sort") sortType: Int
    ) = ResponseEntity(paymentService.getPaymentsByUserDateOutputInfo(userId, monthNumber, yearNumber, sortType), HttpStatus.OK)
